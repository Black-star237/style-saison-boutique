...
const Femmes = () => {
  const categories = [
    { name: "Robes", count: 45, image: "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80" },
    { name: "Tops & Chemises", count: 67, image: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80" },
    { name: "Pantalons & Jeans", count: 38, image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80" },
    { name: "Vestes & Manteaux", count: 29, image: "https://images.unsplash.com/photo-1539533113208-f6df8cc8b543?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80" }
  ];
  ...
  const featuredProducts = [
    {
      ...
      price: "149€",
      originalPrice: "189€",
      image: "https://images.unsplash.com/photo-1566479179817-c83e8b8e7ec7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
      discount: "-21%"
    },
    {
      id: 2,
      ...
      price: "119€",
      image: "https://images.unsplash.com/photo-1584513449080-2e726d9ce5e1?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
    },
    {
      id: 3,
      name: "Jean Taille Haute",
      price: "89€",
      image: "https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
    },
    {
      id: 4,
      name: "Chemisier Satin",
      price: "79€",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/femmes" className="text-amber-600 font-medium hover:text-amber-700 transition-colors">Femmes</Link>
      ...
      <section className="relative bg-gradient-to-r from-pink-50 to-purple-50 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Élégance, sophistication et modernité. Découvrez notre collection exclusive 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Coups de Cœur</h2>
